...
def view_random_images(target_dir, class_names, pashto_dict, color_map='gray'):
    """
    ...
    color_map (str): colormap or cmap of the plot defalut gray
    ...
    for class_name, img_path in random_images.items():
        ...
        plt.imshow(target_img, cmap=color_map)
